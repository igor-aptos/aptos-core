...
EXPECTED_TPS = {
    ...
    ("account-generation", False, 1): (10600.0, True),
    ...
    ("no-op2-signers", False, 1): (18100.0, True),
    ("no-op5-signers", False, 1): (18100.0, True),
...
with tempfile.TemporaryDirectory() as tmpdirname:
    ...
    for (test_index, (transaction_type_name, use_native_executor, module_working_set_size), (
        expected_tps,
        check_active,
